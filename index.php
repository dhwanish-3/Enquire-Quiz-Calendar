...
<head>
  ...
  <!-- the following stylesheet has the icons in the login signup form
    form_container -->
  ...
  <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@800&family=Varela+Round&display=swap"
    rel="stylesheet">
...
<body>
    ...
    <div class="form_container">
      ...
      <div class="form login_form">
        <form action="auth/login.php" method="POST">
          ...
          ?>
          <div class="input_box">
            <input type="email" placeholder="Enter your email" required name="email" value="<?php if (isset($_COOKIE['email']))
              echo $_COOKIE['email']; ?>" />
            <i class="uil uil-envelope-alt email"></i>
          </div>
          <div class="input_box">
            <input type="password" placeholder="Enter your password" required name="password" value="<?php if (isset($_COOKIE['password']))
  ...
  <section class="fav-events">
    ...
    if (isset($_SESSION['general'])) {
      ...
      if (strpos($category, "open") !== false)
        $open = 1;
      if (strpos($category, "school") !== false)
        $school = 1;
      if (strpos($category, "college") !== false)
        $college = 1;
    }
    ?>
    <div class="pop-up-form">
      <form id="submit-go">
        <div class="slider-container">
          <div class="range">
            ...
            <div class="slider">
              ...
              <div class="range-slider">
                <span>0</span>
                <input type="range" class="range-input" id="range-input1" name="general" min="0" max="10"
                  value="<?php echo $general; ?>" step="1">
                <span>10</span>
              </div>
            </div>
          </div>
          <div class="range">
            ...
            <div class="slider">
              ...
              <div class="range-slider">
                <span>0</span>
                <input type="range" class="range-input" id="range-input2" name="scitech" min="0" max="10"
                  value="<?php echo $scitech; ?>" step="1">
                <span>10</span>
              </div>
            </div>
          </div>
          <div class="range">
            ...
            <div class="slider">
              ...
              <div class="range-slider">
                <span>0</span>
                <input type="range" class="range-input" id="range-input3" name="business" min="0" max="10"
                  value="<?php echo $business; ?>" step="1">
                <span>10</span>
              </div>
            </div>
          </div>
          <div class="range">
            ...
            <div class="slider">
              ...
              <div class="range-slider">
                <span>0</span>
                <input type="range" class="range-input" id="range-input4" name="scitechbiz" min="0" max="10"
                  value="<?php echo $scitechbiz; ?>" step="1">
                <span>10</span>
              </div>
            </div>
          </div>
          <div class="range">
            ...
            <div class="slider">
              ...
              <div class="range-slider">
                <span>0</span>
                <input type="range" class="range-input" id="range-input5" name="sports" min="0" max="10"
                  value="<?php echo $sports; ?>" step="1">
                <span>10</span>
              </div>
            </div>
          </div>
          <div class="range">
            ...
            <div class="slider">
              ...
              <div class="range-slider">
                <span>0</span>
                <input type="range" class="range-input" id="range-input6" name="mela" min="0" max="10"
                  value="<?php echo $mela; ?>" step="1">
                <span>10</span>
              </div>
            </div>
          </div>
        ...
        <div class="radios">
          <span>Category :</span>
          <div class="radio">
            <input class="radio-input" type="checkbox" value="1" name="open" id="radio-open" <?php if ($open)
              echo "checked"; ?>>
            <label class="radio-label" for="radio-open">Open</label>
            <input class="radio-input" type="checkbox" value="1" name="school" id="radio-school" <?php if ($school)
              echo "checked"; ?>>
            <label class="radio-label" for="radio-school">School</label>
            <input class="radio-input" type="checkbox" value="1" name="college" id="radio-college" <?php if ($college)
              echo "checked"; ?>>
            ...
            <div class="text-form-fields">
              ...
              <div class="form-field">
                <input type="text" onfocus="(this.type='date')" onblur="if(!this.value) this.type='text'"
                  placeholder="Enter date of the event" required name="date">
              </div>
              <div class="form-field">
